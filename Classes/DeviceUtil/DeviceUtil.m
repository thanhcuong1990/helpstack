...
+ (NSString*)hardwareDevice {
    ...
    if ([hardware isEqualToString:iPhone3_3])    return @"iPhone 4_CDMA";
    if ([hardware isEqualToString:iPhone4_1])    return @"iPhone 4S";
    
    if ([hardware isEqualToString:iPhone5_1])    return @"iPhone 5";
    if ([hardware isEqualToString:iPhone5_2])    return @"iPhone 5_CDMA_GSM";
    if ([hardware isEqualToString:iPhone5_3])    return @"iPhone 5C";
    if ([hardware isEqualToString:iPhone5_4])    return @"iPhone 5C_CDMA_GSM";
    if ([hardware isEqualToString:iPhone6_1])    return @"iPhone 5S";
    if ([hardware isEqualToString:iPhone6_2])    return @"iPhone 5S_CDMA_GSM";
    
    if ([hardware isEqualToString:iPhone7_1])    return @"iPhone 6_PLUS";
    if ([hardware isEqualToString:iPhone7_2])    return @"iPhone 6";
    if ([hardware isEqualToString:iPhone8_1])    return @"iPhone 6S";
    if ([hardware isEqualToString:iPhone8_2])    return @"iPhone 6S_PLUS";
